      ...
      <ul class="nav navbar-nav">
	      ...
	      <li class="dropdown">
            ...
            <?php endif;  ?>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-search"></span> Consulta<b class="caret"></b></a>
          <ul class="dropdown-menu">
            ...
            <!-- <span class="glyphicon glyphicon-cog"></span> Solicitação <b class="caret"></b></a> -->
							<ul class="dropdown-menu">
		          	<li><a href="../_phphtml/con_sol_aberta.php"><span class="glyphicon glyphicon-hand-right"></span> Solicitações Abertas</a></li>
		          	<li><a href="../_phphtml/con_sol_concluido.php"><span class="glyphicon glyphicon-thumbs-up"></span> Solicitações Concluidas</a></li>
		          	<li><a href="../_phphtml/con_sol_cancelado.php"><span class="glyphicon glyphicon-thumbs-down"></span> Solicitações Canceladas</a></li>
                <li><a href=".._phphtml/consulta_solicitacao.php"><span class="glyphicon glyphicon-cog"></span> Todas Solicitações</a></li>
		          </ul>
						</li>
